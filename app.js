...
function updateApplicationStatuses(){
  ...
  events.forEach(e=>{
    (e.applications||[]).forEach(a=>{
      if(a.status==="当選"||a.status==="落選"){a.status="応募済み";changed=true;}
...
function applicationStatusSummary(e){
 ...
 const priority={"受付中":100,"応募予定":90,"受付前":80,"当落発表待ち":70,"応募済み":60,"受付終了":20,"未応募":10};
...
function statusClass(status){return ({"受付中":"open","応募予定":"planned","受付前":"before","当落発表待ち":"waiting","応募済み":"applied","受付終了":"closed","未応募":"none"}[status]||"none")}
