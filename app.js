...
const state={page:"home",returnPage:"home",eventId:null,eventReturnPage:"home",productId:null,scheduleId:null,orderId:null,saleItemIndex:null,calendarDate:new Date(),selectedDate:new Date(),filters:{events:{type:"",keyword:""},products:{type:"",keyword:""},schedules:{type:"",keyword:""}},scheduleSections:{current:true,future:true,past:false}};
...
function openEvent(id){state.eventReturnPage=state.page;state.returnPage=state.page;state.eventId=id;state.page="event";render()}
function home(){
...
function addApplication(eventId){state.eventReturnPage=state.returnPage||"events";state.returnPage="event";state.eventId=eventId;state.orderId=null;state.page="orderForm";render()}
function editApplication(eventId,appId){state.eventReturnPage=state.returnPage||"events";state.returnPage="event";state.eventId=eventId;state.orderId=appId;state.page="orderForm";render()}
...
function openCalendarDetail(item){
 ...
 if(item.kind==="event"){state.eventReturnPage="calendar";state.returnPage="calendar";state.eventId=item.entityId;state.page="event";render();}
